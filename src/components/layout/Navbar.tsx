      ...
      <nav className="container flex h-18 sm:h-20 items-center justify-between">
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <span className="flex size-9 items-center justify-center rounded-full bg-accent text-accent-foreground">
            <Dumbbell className="size-5" strokeWidth={2.25} />
          </span>
        ...
        <div className="flex items-center gap-3">
          <Button href="/pricing" className="hidden md:inline-flex" icon={false}>
            Join Now
          </Button>
          <button
        ...
        {isOpen && (
          ...
          >
            <div className="container flex flex-col gap-1 py-5">
              ...
              <Button href="/pricing" className="mt-3 w-full" icon={false}>
                Join Now
              </Button>
            </div>
          </motion.div>
